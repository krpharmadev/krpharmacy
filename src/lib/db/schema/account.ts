...
import { pgTable, uuid, text, timestamp, integer, boolean, uniqueIndex, pgEnum } from 'drizzle-orm/pg-core';
...
export const accounts = pgTable('accounts', {
  ...
  uniqueProvider: uniqueIndex('unique_provider').on(table.provider, table.providerAccountId),
}));
