...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-2xl font-bold mb-6 text-center text-green-600">เข้าสู่ระบบ</h1>
      ...
      <form onSubmit={handleCredentialsLogin} className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/web/forgot-password" className="text-sm text-green-600 hover:text-green-500">
            ลืมรหัสผ่าน?
          </Link>
        </div>
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-600">
          ยังไม่มีบัญชี?{' '}
          <Link href="/web/register" className="font-medium text-green-600 hover:text-green-500">
            ลงทะเบียนเลย
          </Link>
        </p>
      </div>
